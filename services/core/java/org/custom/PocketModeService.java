...
public class PocketModeService {
    ...
    public static final String ACTION_POCKET_STATE_CHANGED = "org.custom.server.action.POCKET_STATE_CHANGED";
    ...
    private PocketModeService(Context context) {
        ...
        IntentFilter filter = new IntentFilter("org.custom.server.action.AOD_STATE_CHANGED");
