...
public class NetworkTraffic extends TextView {
    ...
    public NetworkTraffic(Context context, AttributeSet attrs, int defStyle) {
        ...
        mWidth = resources.getDimensionPixelSize(com.android.systemui.res.R.dimen.network_traffic_width);
        setMode();
    ...
    protected void setSpacingAndFonts() {
        setTextAppearance(com.android.systemui.res.R.style.TextAppearance_QS_Status);
